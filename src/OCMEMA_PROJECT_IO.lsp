    ...
    (cond
      ...
      ((= opt "T")
       (if (ocmema:proj-ready-for-generators-p)
         (progn
           (ocmema:proj-msg "Ejecutando generador de Trabes...")
           (command "_.GEN_TRABES")
           (ocmema:proj-msg "Generador finalizado.")
         )
       )
      )
      ((= opt "N")
       (if (ocmema:proj-ready-for-generators-p)
         (progn
           (ocmema:proj-msg "Ejecutando generador de Nervaduras...")
           (command "_.GEN_NERV")
           (ocmema:proj-msg "Generador finalizado.")
         )
       )
